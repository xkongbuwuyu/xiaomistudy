...
MySQL - 5.5.40 : Database - xiaomidb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`xiaomidb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci */;
...
insert  into `orders`(`orders_number`,`uid`,`sum_price`,`state`,`create_time`,`count_number`) values ('12021123013190439275145323815710',1,15000,2,'2021-12-30 13:19:04',1),('12021123109122936875146816957831',1,998,2,'2021-12-31 09:12:29',1);
...
insert  into `trolley`(`tid`,`uid`,`pid`,`number`,`orders_number`) values (1,1,15,1,'12021123013190439275145323815710'),(5,1,24,1,'12021123109122936875146816957831');
...
insert  into `user`(`id`,`name`,`sex`,`phone_number`,`area`,`manager`,`username`,`password`,`photo`,`create_time`) values (1,'张安',0,'13113305869','西安',1,'admin','123456','1.jpg','2019-11-23 10:20:00'),(2,'张三',0,'15454787457','萍乡',0,'admin1','123456','1.jpg','2021-12-16 08:53:38');
