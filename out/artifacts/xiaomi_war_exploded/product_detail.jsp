   ...
   <div class="box">
    ...
    <div class="plus5_no3">
        <div class="plus5_no3_img">
            <img width="560px" height="560px" src="${pageContext.request.contextPath}/file/${product.pic}" style="display: block" alt="">
        </div>
        <div class="plus5_no3_right">
            <h3>商品名称：</h3>
            <p class="plus5_no3_right_p2">
            	<span class="plus5_no3_right_span2">「${product.name}」</span>
            </p>
            <p class="plus5_no3_right_p3">价格：${product.price}元</p>
            
            <h3>商品编号：${product.pid}</h3>
            <div class="plus5_no3_right_div4">
				<h3>购买数量：<input id="count" name="count" value="1" size="10"></h3>
            </div>
            <a href="javascript:void(0)" onclick="addTrolley('${product.pid}')" >
                <div class="plus5_no3_right_div11" style="cursor: pointer;" >加入购物车</div>
            </a>
   ...
   <script>
       function addTrolley(pid) {
           ...
           $.ajax({
               ...
               "type":"post",
               "data":{"mark":"addTrolley","pid":pid,"num":num},
               "dataType":"text",
               "success":function (data) {
                   if (data=="true"){
                       alert("添加购物车成功");
                       window.location.href="${pageContext.request.contextPath}/indexServlet?mark=showInfoIndex"
                   }else{
                       alert("添加购物车失败")
                   }
               },
