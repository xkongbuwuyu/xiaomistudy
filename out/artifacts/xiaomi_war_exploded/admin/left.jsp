...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            ...
            <li>
                <cite></cite>
                <a href="${pageContext.request.contextPath}/userServlet?mark=showAdmin" target="rightFrame">用户管理</a>
                <i></i>
            </li>

            <li><cite></cite><a href="" target="rightFrame">商品类别管理</a><i></i></li>
            <li>
                <cite></cite>
                <a href="${pageContext.request.contextPath}/productServlet?mark=showProductAdmin" target="rightFrame">商品管理</a>
                <i></i>
            </li>

            <li><cite></cite><a href="" target="rightFrame">添加商品</a><i></i></li>
            </a><i></i></li>
